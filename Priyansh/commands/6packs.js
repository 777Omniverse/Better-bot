...
"https://i.imgur.com/aV4WVsq.jpg"
     ...
     var callback = () => api.sendMessage({body:`If you are not go then look at this Six Pack -.-`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
